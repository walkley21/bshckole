...
<div class="row">
        <div class="col-xs-12">
                ...
                <div class="row">
                        <div class="col-xs-12">
                                ...
                                <!---->
                                <a
                                   href="<?php echo site_url('/students/ajax/parent/group/parent_id/'.$object->id)?>" 
                                   data-target="#modal-table" 
                                   role="button"
                                   data-toggle="modal"
                                   style="width: 160px;float:right" 
                                   class="btn btn-app btn-success btn-xs green" >
				    ...
				    Agregar Alumno
                                ...
                                <div class="table-responsive">
                                  ...
                                  <table id="sample-table-2" class="table table-striped table-bordered table-hover dataTable" aria-describedby="sample-table-2_info">
                                        ...
                                        <tbody role="alert" aria-live="polite" aria-relevant="all"  id="replace-me">
	...
	<div id="modal-table-new" class="modal fade" tabindex="-1">
